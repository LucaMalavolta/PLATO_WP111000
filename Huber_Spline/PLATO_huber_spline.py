...
import pandas as pd
from wotan_huber_spline import filter_huber_spline, get_gaps_indexes
...
knot_distance=0.3 # Default in wotan
break_tolerance = knot_distance / 2 # Default in wotan
...
for i in range(len(gaps_indexes) - 1):
    ...
    filter_segment  = filter_huber_spline(time_view, flux_view, mask_view, knot_distance=knot_distance)
